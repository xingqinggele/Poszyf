...
public class RequestMode {
   ...
   * @param clazz 需要解析的实体类
   */
  public static void postRequest(String url, RequestParams params, ResponseCallback callback, Class<?> clazz) {
   ...
   * @param clazz 需要解析的实体类
   */
  public static void postRequest2(String url, RequestParams params, int[] data, ResponseCallback callback, Class<?> clazz) {
    CommonOkHttpClient.post(CommonRequest.createPostRequest2(url,params,data),
            new ResposeDataHandle(callback, clazz));
  }
   ...
   * @param clazz 需要解析的实体类
   */
  public static void postRequest3(String url, RequestParams params, List<OrderBean>data, ResponseCallback callback, Class<?> clazz) {
    CommonOkHttpClient.post(CommonRequest.createPostRequest3(url,params,data),
            new ResposeDataHandle(callback, clazz));
  }
