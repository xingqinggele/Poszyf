package com.example.poszyf.useractivity;
...
import com.example.poszyf.utils.CountDownTimerUtils;
...
public class RetrievePassActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void getRetrieve(String code, String userName, String passWord) {
        ...
        HttpRequest.getPass1(params, new ResponseCallback() {
            @Override
    ...
    public void getPhoneCode1(String Phone) {
        ...
        HttpRequest.getRegister_Code1(params, new ResponseCallback() {
            @Override
            public void onSuccess(Object responseObj) {
                try {
