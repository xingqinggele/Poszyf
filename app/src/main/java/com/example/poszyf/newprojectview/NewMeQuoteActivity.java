...
import com.example.poszyf.newprojectview.adapter.MeQuoDialogGridViewAdapter;
import com.example.poszyf.newprojectview.adapter.QuoteAdapter;
import com.example.poszyf.newprojectview.bean.NewMeQuoBean;
import com.example.poszyf.newprojectview.bean.QuoteBean;
import com.example.poszyf.newprojectview.editMerchats.EditMerchantsActivity1;
import com.example.poszyf.newprojectview.editMerchats.EditNewMerchantsActivity;
...
public class NewMeQuoteActivity extends BaseActivity implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener, QuoteAdapter.BindCallback, QuoteAdapter.EditCallback {
    ...
    private void posData(boolean isRefresh){
        ...
        HttpRequest.postFyMerch(params, new ResponseCallback() {
            //成功回调
            @Override
