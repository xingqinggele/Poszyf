...
import com.example.poszyf.BuildConfig;
...
import com.example.poszyf.utils.BitMapUtil;
import com.example.poszyf.utils.VideoUtil;
...
public class DemoActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void getDataFaceId() {
        ...
        HttpRequest.postFaceID(params,new ResponseCallback() {
            @Override
    ...
    public void openCloudFaceService(String sign) {
        ...
        WbCloudFaceVerifySdk.getInstance().initWillSdk(DemoActivity.this, data, new WbCloudFaceVerifyLoginListener() {
            ...
            public void onLoginSuccess() {
                ...
                //【特别注意】请使用activity context拉起sdk
                //【特别注意】请在主线程拉起sdk！
                WbCloudFaceVerifySdk.getInstance().startWbFaceVerifySdk(DemoActivity.this,
                            ...
                            public void onFinish(WbFaceVerifyResult result) {
                                ...
                                if (result != null) {
                                    if (result.isSuccess()) {
                                        ...
                                        if (!isShowSuccess) {
                                            Toast.makeText(DemoActivity.this, "刷脸成功", Toast.LENGTH_SHORT).show();
                                        ...
                                        if (error != null) {
                                            ...
                                            if (!isShowSuccess) {
                                                Toast.makeText(DemoActivity.this, "刷脸失败!" + error.getDesc(), Toast.LENGTH_LONG).show();
                                            }
                                        } else {
            ...
            public void onLoginFailed(WbFaceError error) {
                ...
                if (error != null) {
                    ...
                    if (error.getDomain().equals(WbFaceError.WBFaceErrorDomainParams)) {
                        Toast.makeText(DemoActivity.this, "传入参数有误！" + error.getDesc(), Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(DemoActivity.this, "登录刷脸sdk失败！" + error.getDesc(), Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Log.e(TAG, "sdk返回error为空！");
                }
    ...
    private void posVideo(String str){
        ...
        HttpRequest.posVideoUpload(params, new ResponseCallback() {
            //成功回调
            @Override
            public void onSuccess(Object responseObj) {
                loadDialog.dismiss();
