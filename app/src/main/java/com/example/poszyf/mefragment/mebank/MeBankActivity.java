...
//        ，如有疑问，请拨打客服热线：" + SPUtils.get(MeBankActivity.this, "servicePhone", "-1").toString()
        me_bank_tv.setText("为了保障您的资金账户安全，请务必添加您本人持有的银行卡");
        posData();
    }
    ...
    public void posData() {
        ...
        HttpRequest.getBankInfo(params, new ResponseCallback() {
            @Override
