...
import com.example.poszyf.mefragment.meorder.fragment.ApplyExchangeFragment;
import com.example.poszyf.mefragment.meorder.fragment.MeExchangeFragment;
...
public class MeOrderActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void posOrderType(){
        ...
        HttpRequest.getOrderType(params, new ResponseCallback() {
            @Override
