package com.example.poszyf.mefragment.meorder.fragment;
...
import com.example.poszyf.mefragment.meorder.adapter.CeshiAdapter1;
import com.example.poszyf.mefragment.meorder.adapter.HomeintegerselectAdapter;
import com.example.poszyf.mefragment.meorder.bean.MeExhangeItemBean;
...
public class HomeIntegerSelectFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, PullLoadMoreRecyclerView.PullLoadMoreListener, View.OnClickListener {
    ...
    public void postData() {
        ...
        HttpRequest.getEquipmentList(params,new ResponseCallback() {
            @Override
    ...
    public void posRWData(){
        ...
        HttpRequest.getTypeList(params,new ResponseCallback() {
            @Override
            public void onSuccess(Object responseObj) {
                mSwipeRefreshLayout.setRefreshing(false);
                Gson gson = new GsonBuilder().serializeNulls().create();
