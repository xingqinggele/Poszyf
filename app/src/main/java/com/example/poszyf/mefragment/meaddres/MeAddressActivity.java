...
public class MeAddressActivity extends BaseActivity implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void posData(boolean isRefresh, boolean value) {
        ...
        HttpRequest.getAddressList(params, new ResponseCallback() {
            @Override
    ...
    public void AddressType(String id) {
        RequestParams params = new RequestParams();
        params.put("id", id);
        HttpRequest.getAddressType(params, new ResponseCallback() {
            @Override
            public void onSuccess(Object responseObj) {
                setRefresh(false);
            }
    ...
    public void AddressDelete(String id) {
        RequestParams params = new RequestParams();
        params.put("id", id);
        HttpRequest.DeleteAddress(params, new ResponseCallback() {
            @Override
            public void onSuccess(Object responseObj) {
                //删除成功刷新列表
                setRefresh(false);
