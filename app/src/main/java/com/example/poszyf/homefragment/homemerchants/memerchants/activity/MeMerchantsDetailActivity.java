package com.example.poszyf.homefragment.homemerchants.memerchants.activity;
...
import com.example.poszyf.homefragment.homemerchants.memerchants.adapter.MerchatsDetailAdapter;
...
import com.example.poszyf.homefragment.homemerchants.memerchants.bean.TradingEvnBusBean;
import com.example.poszyf.homefragment.homemerchants.memerchants.fragment.EquipmentFragment;
import com.example.poszyf.homefragment.homemerchants.memerchants.fragment.TradingFragment;
...
public class MeMerchantsDetailActivity extends BaseActivity implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void posData() {
        ...
        HttpRequest.getQueryMyCommercialTenant(params, new ResponseCallback() {
            @Override
