...
import com.example.poszyf.datafragment.databenefit.adapter.DataBenefitAdapter;
...
import com.example.poszyf.homefragment.homemerchants.memerchants.adapter.MeMerchantsTransferAdapter;
import com.example.poszyf.homefragment.homemerchants.memerchants.bean.MeMerchantsTransferBean;
...
public class MeMerchantsTransferActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener, View.OnClickListener {
    ...
    private void posData() {
        ...
        HttpRequest.getTransferList(params, new ResponseCallback() {
            //成功回调
            @Override
    ...
    private void subData(String merId,String snCode){
        ...
        HttpRequest.getTransferMerchants(params, new ResponseCallback() {
            @Override
            public void onSuccess(Object responseObj) {
                try {
                    JSONObject result = new JSONObject(responseObj.toString());
