package com.example.poszyf.homefragment.homeequipment.fragment.record;
...
import com.example.poszyf.homefragment.homeequipment.activity.RecordDetailsActivity;
import com.example.poszyf.homefragment.homeequipment.adapter.CallbackRecordAdapter;
import com.example.poszyf.homefragment.homeequipment.adapter.ChooserRecyclerAdapter;
import com.example.poszyf.homefragment.homeequipment.adapter.RecordListAdapter;
import com.example.poszyf.homefragment.homeequipment.bean.CallbackRecordBean;
import com.example.poszyf.homefragment.homeequipment.bean.TerminalBean;
import com.example.poszyf.homefragment.homemessage.adapter.BusinessMessageAdapter;
import com.example.poszyf.homefragment.homemessage.bean.BusinessMessageBean;
...
import static com.example.poszyf.utils.TimeUtils.getNowTime;
...
public class CallbackRecordFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener, View.OnClickListener {
    ...
    public void posData(boolean isRefresh) {
        ...
        HttpRequest.getRecords(params,new ResponseCallback() {
            @Override
