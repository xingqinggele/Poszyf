package com.example.poszyf.homefragment.homelist.fragment;
...
import com.example.poszyf.homefragment.homelist.adapter.HomeListAdapter;
import com.example.poszyf.homefragment.homelist.bean.HomeRankingBean;
...
public class ThisMonthFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    private void posData(boolean value) {
        ...
        HttpRequest.getRanking(params,new ResponseCallback() {
            @Override
