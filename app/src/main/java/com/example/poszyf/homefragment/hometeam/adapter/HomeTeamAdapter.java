package com.example.poszyf.homefragment.hometeam.adapter;
...
import com.example.poszyf.adapter.ChooseGridViewAdapter;
import com.example.poszyf.homefragment.hometeam.HomeTeamActivity;
import com.example.poszyf.homefragment.hometeam.HomeTeamDetailsActivity;
import com.example.poszyf.homefragment.hometeam.bean.HomeTeamBean;
...
public class HomeTeamAdapter extends BaseQuickAdapter<TeamBean, BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder holder, TeamBean report) {
        ...
        if (TextUtils.isEmpty(report.getPartnerName())) {
            ...
            holder.setVisible(R.id.home_team_phone_btn,false);
        } else {
            ...
            holder.setVisible(R.id.home_team_phone_btn,true);
