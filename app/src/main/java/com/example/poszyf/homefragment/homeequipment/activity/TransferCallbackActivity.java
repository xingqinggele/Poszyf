...
import com.example.poszyf.homefragment.homeequipment.adapter.ChooserListAdapter;
import com.example.poszyf.homefragment.homeequipment.bean.CallbackEvenBusBean;
import com.example.poszyf.homefragment.homeequipment.bean.CallbackEvenBusBean1;
import com.example.poszyf.homefragment.homeequipment.bean.ScreeningBean;
import com.example.poszyf.homefragment.homeequipment.fragment.callback.CallIntervalFragment;
import com.example.poszyf.homefragment.homeequipment.fragment.callback.CallSelectFragment;
...
//        fragmentList.add(new CallIntervalFragment());
    ...
    public void postData1() {
        ...
        HttpRequest.getConditions(params, new ResponseCallback() {
            @Override
