...
import com.example.poszyf.mefragment.setup.MePayPassOptionsActivity;
...
import static com.example.poszyf.utils.DESHelperUtil.decrypt;
import static com.example.poszyf.utils.DESHelperUtil.encrypt;
import static com.example.poszyf.utils.Utility.format2Decimal;
...
//                withdrawal_money_ed.setText("1");
    ...
    public void PayData(String psw) {
        ...
        HttpRequest.getPayPassWord(params, new ResponseCallback() {
            //成功回调
    ...
    public void getPayData() {
        ...
        HttpRequest.getPayData(params, new ResponseCallback() {
            //成功回调
            @RequiresApi(api = Build.VERSION_CODES.O)
            @Override
            public void onSuccess(Object responseObj) {
