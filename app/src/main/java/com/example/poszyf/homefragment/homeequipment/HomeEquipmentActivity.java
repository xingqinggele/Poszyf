...
import com.example.poszyf.homefragment.homeequipment.activity.TerminalActivity;
import com.example.poszyf.homefragment.homeequipment.activity.TerminalRecordActivity;
...
public class HomeEquipmentActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void posData(){
        ...
        HttpRequest.getEquipment(params, new ResponseCallback() {
            @Override
