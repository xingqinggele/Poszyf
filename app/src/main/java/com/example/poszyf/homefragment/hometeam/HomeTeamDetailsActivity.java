...
import com.example.poszyf.homefragment.hometeam.bean.HomeTeamChartBean;
...
import com.example.poszyf.views.MPLineChartManager;
import com.example.poszyf.views.MyDialog1;
import com.example.poszyf.views.MyMarkerView;
...
public class HomeTeamDetailsActivity extends BaseActivity implements View.OnClickListener, RadioGroup.OnCheckedChangeListener {
    ...
    public void posData() {
        ...
        HttpRequest.updMypartnerDetail(params, new ResponseCallback() {
            @Override
    ...
    private void getEquipmentData(String equipmentStatus) {
        ...
        HttpRequest.getEquipmentDataList(params, new ResponseCallback() {
            @Override
            public void onSuccess(Object responseObj) {
                //需要转化为实体对象
    ...
    private void getTradingData(String tradingStatus) {
        ...
        HttpRequest.getTradingDataList(params, new ResponseCallback() {
            @Override
            public void onSuccess(Object responseObj) {
                //需要转化为实体对象
                Gson gson = new GsonBuilder().serializeNulls().create();
