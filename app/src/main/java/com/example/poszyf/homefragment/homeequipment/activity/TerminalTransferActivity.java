...
import com.example.poszyf.adapter.ChooseGridViewAdapter1;
...
import com.example.poszyf.homefragment.homeequipment.bean.TerminalActivityBean;
...
//                }
    ...
    public void postData1() {
        ...
        HttpRequest.getPosBrandTypeAll(params, new ResponseCallback() {
            @Override
