package com.example.poszyf.datafragment.datapersonalresults.fragment;
...
import com.example.poszyf.datafragment.datapersonalresults.adapter.DataTradingVolumeAdapter;
import com.example.poszyf.datafragment.datapersonalresults.bean.DataPersonBean;
...
public class DataDayPartnerFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    public void posData(boolean isRefresh){
        ...
        HttpRequest.getManthAmount(params, new ResponseCallback() {
            @Override
